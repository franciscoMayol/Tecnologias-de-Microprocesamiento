...
config:
	...
	;LED PD0: Listo para lavar
	;LED PD1: Proceso de lavado
...
ligera:
	...
	sbi PORTD, 1	;prendo led que indica proceso de lavado
	...
	cbi PORTD, 1	;apago led que indica proceso de lavado
